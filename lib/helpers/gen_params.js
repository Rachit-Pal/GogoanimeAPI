...
const fetch_keys = async() => {
    ...
    return {
        iv: CryptoJS.enc.Utf8.parse(hexlify.unhexlify(res.iv)),
        key: CryptoJS.enc.Utf8.parse(hexlify.unhexlify(res.key)),
        second_key: CryptoJS.enc.Utf8.parse(hexlify.unhexlify(res.second_key))
    };
}
